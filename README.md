...
1. Open this [hiro marker image](./data/images/HIRO.jpg) in your desktop browser.
...
- [Pattern Marker Training](./three.js/examples/marker-training/examples/generator.html) :
...
- [ARCode Generator](./three.js/examples/arcode.html) :
...
[ALL EXAMPLES](.-docs/misc/EXAMPLES.html)
...
[FUTURE.md](.-docs/misc/FUTURE.html)

# FAQ

[FAQ.md](.-docs/misc/FAQ.html)
